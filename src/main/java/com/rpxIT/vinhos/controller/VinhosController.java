package com.rpxIT.vinhos.controller;
...
import com.rpxIT.vinhos.model.TipoVinho;
import com.rpxIT.vinhos.model.Vinho;
import com.rpxIT.vinhos.repository.Vinhos;
import com.rpxIT.vinhos.repository.filter.VinhoFilter;
...
public class VinhosController {
	...
	public ModelAndView salvar(@Valid Vinho vinho, BindingResult result,
		...
		vinhos.save(vinho);		
		atributes.addFlashAttribute("mensagem", "Vinho salvo com sucesso!");
